...
set_property PACKAGE_PIN U8 [get_ports {CW}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {CW}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {LeftNS}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {LeftNS}]
...
set_property PACKAGE_PIN T8 [get_ports {leftLight[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leftLight[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports {leftLight[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leftLight[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports {leftLight[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leftLight[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {output[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {output[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {q[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {q[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {q[5]}]					
...
#set_property PACKAGE_PIN R1 [get_ports {Qstate[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Qstate[0]}]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {Qstate[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Qstate[1]}]
#Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {Qstate[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Qstate[2]}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {Qo}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Qo}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {Cro}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Cro}]


#Bank = 34, Pin name = IO_L5P_T0_34,						Sch name = LED16_R
set_property PACKAGE_PIN K5 [get_ports {lights[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports lights[3]]
#Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports {lights[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {lights[5]}]
#Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports {lights[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights[4]}]
#Bank = 34, Pin name = IO_0_34,								Sch name = LED17_R
set_property PACKAGE_PIN K6 [get_ports {lights[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights[0]}]
#Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LED17_G
set_property PACKAGE_PIN H6 [get_ports {lights[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {lights[2]}]
#Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,			Sch name = LED17_B
set_property PACKAGE_PIN L16 [get_ports {lights[1]}]					
...
#set_property PACKAGE_PIN E16 [get_ports {Clock}]						
